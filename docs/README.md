...
FitLife Planner's area docs: `architecture.md`, `database.md`, `api.md`, `roadmap.md`,
`development.md`, plus this file's own conventions. All start as skeletons — content
lands during ETAP 1 (architecture analysis) and beyond, per `roadmap.md`.
